...
export default function App() {
  ...
  // const updateNewPrediction = async (newPrediction) => {
  //   newPrediction = await predictionApi.post();
  //   setNewPrediction(predictions.concat(newPrediction));
  //   newPredictions = {
  //     ...predictions,
